...
stanford_structs.out:     file format elf64-x86-64
...
0000000000400546 <main>:
  ...
  40055b:	31 c0                	xor    %eax,%eax
               ; mov a memory address of something 32 bytes below rbp to rax
	       ; mov the memory address of the student1 struct to rax
	       ; struct student* ptr_student = &student;
  40055d:	48 8d 45 e0          	lea    -0x20(%rbp),%rax
               ; mov the value of rax to a memory location 40 below rbp
	       ; ptr_student is stored at that memory location $rbp - 40
  400561:	48 89 45 d8          	mov    %rax,-0x28(%rbp)
               ; mov A to $rbp - 24
  400565:	c6 45 e8 41          	movb   $0x41,-0x18(%rbp)
               ; mov B to $rbp - 23
  400569:	c6 45 e9 42          	movb   $0x42,-0x17(%rbp)
  40056d:	c6 45 ea 43          	movb   $0x43,-0x16(%rbp)
  400571:	c6 45 eb 44          	movb   $0x44,-0x15(%rbp)
  400575:	c6 45 ec 45          	movb   $0x45,-0x14(%rbp)
  400579:	c6 45 ed 46          	movb   $0x46,-0x13(%rbp)
  40057d:	c6 45 ee 47          	movb   $0x47,-0x12(%rbp)
               ; mov H to $rbp - 17
  400581:	c6 45 ef 48          	movb   $0x48,-0x11(%rbp)
               ; mov 12 to $rbp - 16
  400585:	c7 45 f0 0c 00 00 00 	movl   $0xc,-0x10(%rbp)
  40058c:	b8 00 00 00 00       	mov    $0x0,%eax
  400591:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
  400595:	64 48 33 14 25 28 00 	xor    %fs:0x28,%rdx
  40059c:	00 00 
  40059e:	74 05                	je     4005a5 <main+0x5f>
  4005a0:	e8 7b fe ff ff       	callq  400420 <__stack_chk_fail@plt>
  4005a5:	c9                   	leaveq 
  4005a6:	c3                   	retq   
