...
0000000000400546 <main>:
  ...
  40054a:	48 83 ec 60          	sub    $0x60,%rsp
  40054e:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
  400555:	00 00 
  400557:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
  40055b:	31 c0                	xor    %eax,%eax
  40055d:	66 0f ef c0          	pxor   %xmm0,%xmm0
  400561:	f2 0f 11 45 a0       	movsd  %xmm0,-0x60(%rbp)
  400566:	c6 45 a8 61          	movb   $0x61,-0x58(%rbp)
  40056a:	66 c7 45 aa 09 00    	movw   $0x9,-0x56(%rbp)
  400570:	c7 45 ac 01 00 00 00 	movl   $0x1,-0x54(%rbp)
  400577:	c7 45 b0 02 00 00 00 	movl   $0x2,-0x50(%rbp)
  40057e:	c7 45 b4 03 00 00 00 	movl   $0x3,-0x4c(%rbp)
  400585:	c7 45 b8 04 00 00 00 	movl   $0x4,-0x48(%rbp)
  40058c:	c7 45 bc 05 00 00 00 	movl   $0x5,-0x44(%rbp)
  400593:	c6 45 c0 62          	movb   $0x62,-0x40(%rbp)
  400597:	66 0f ef c0          	pxor   %xmm0,%xmm0
  40059b:	f2 0f 11 45 c8       	movsd  %xmm0,-0x38(%rbp)
  4005a0:	c6 45 d0 63          	movb   $0x63,-0x30(%rbp)
  4005a4:	66 c7 45 d2 08 00    	movw   $0x8,-0x2e(%rbp)
  4005aa:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%rbp)
  4005b1:	c7 45 d8 02 00 00 00 	movl   $0x2,-0x28(%rbp)
  4005b8:	c7 45 dc 03 00 00 00 	movl   $0x3,-0x24(%rbp)
  4005bf:	c7 45 e0 04 00 00 00 	movl   $0x4,-0x20(%rbp)
  4005c6:	c7 45 e4 05 00 00 00 	movl   $0x5,-0x1c(%rbp)
  4005cd:	c6 45 e8 64          	movb   $0x64,-0x18(%rbp)
  4005d1:	b8 00 00 00 00       	mov    $0x0,%eax
  4005d6:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
  4005da:	64 48 33 14 25 28 00 	xor    %fs:0x28,%rdx
  4005e1:	00 00 
  4005e3:	74 05                	je     4005ea <main+0xa4>
  4005e5:	e8 36 fe ff ff       	callq  400420 <__stack_chk_fail@plt>
  4005ea:	c9                   	leaveq 
  4005eb:	c3                   	retq   
