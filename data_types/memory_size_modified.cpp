...
int main() {
   ...
   */
   ...
   int num1 = 4294967297;
   long long int num2 = 4294967297;
   cout << "int value: " << num1 << endl;
   cout << "long long int value: " << num2 << endl;

   int integer1 = 1000400000;
   int integer2 = 1000000000;
   int integer3 = 1000000543;
   long long int integer4 = (static_cast<long long int>(integer1) + integer2 + integer3) / 3;
   int integer5 = integer1/3 + integer2/3 + integer3/3;
   cout << "Average value: " << integer4 << endl;
   cout << "Average value: " << integer5 << endl;
